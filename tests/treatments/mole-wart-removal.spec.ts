...
test.describe('Mole Wart Removal Page', () => {
  ...
  test('loads correctly with TreatmentImage components', async ({ page, baseURL }) => {
    ...
    await expect(page.getByRole('heading', { level: 1, name: /Mole, Wart & Skin Growth/i })).toBeVisible();
    ...
    await expect(page.getByText('Mole, Wart & Skin Growth Removal:', { exact: false })).toBeVisible();
