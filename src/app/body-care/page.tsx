...
const bodyCareServices = [
  ...
  { id: 2, title: 'Perfect Buttocks', slug: 'perfect-buttocks', description: 'Revolutionary Peach Lift Sculpting Machine technology for advanced muscle building and fat reduction.' },
  { id: 3, title: 'Body Sculpting', slug: 'body-sculpting', description: 'Non-invasive techniques that target stubborn fat cells to contour and shape your body.' },
  { id: 4, title: 'Cellulite Reduction', slug: 'cellulite-reduction', description: 'Advanced treatments that smooth and firm skin affected by cellulite.' },
  { id: 5, title: 'Skin Tightening', slug: 'skin-tightening', description: 'Focused treatments that firm loose skin and improve overall elasticity.' },
  { id: 6, title: 'Body Hydration', slug: 'body-hydration', description: 'Deep moisturizing treatments that transform dry, dull skin into smooth, radiant surfaces.' },
  { id: 7, title: 'Detox Wraps', slug: 'detox-wraps', description: 'Luxurious body wraps that draw out impurities while nourishing your skin.' },
  { id: 8, title: 'Anti-Aging Body Treatments', slug: 'anti-aging-body', description: 'Comprehensive treatments that address signs of aging on the body, not just the face.' },
]
