    ...
    <div className="flex flex-col">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="mt-6 text-lg text-gray-600 leading-relaxed">
                Our cutting-edge Mole Wart Skin Growth Removal treatment uses the latest in laser technology to precisely target and remove unwanted skin growths with minimal discomfort and downtime.
              </p>
              <p className="mt-4 text-lg text-gray-600 leading-relaxed">
                This advanced treatment delivers concentrated energy directly to the targeted area, vaporizing unwanted cells while protecting surrounding healthy tissue, resulting in clearer, smoother skin with reduced scarring compared to traditional removal methods.
              </p>
              <div className="mt-8">
                <Link href="/contact">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="font-serif text-3xl md:text-4xl font-bold">
              Mole Wart Removal: <span className="text-primary">Innovative Laser Technology</span>
            </h2>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl text-center">
            <h2 className="font-serif text-3xl md:text-4xl font-bold">
              Benefits of <span className="text-primary">Mole Wart Removal</span>
            </h2>
            <p className="mt-6 text-lg text-gray-600">
