              ...
              <div className="mt-8 space-y-8">
                <Card className="overflow-hidden border border-gray-200 shadow-sm">
                  <CardContent className="p-6">
                    <h3 className="mb-4 text-xl font-bold">旺角分店 / Mongkok Branch</h3>
                    <div className="space-y-4 text-gray-700">
                      <p className="flex items-start">
                        ...
                        <span>
                          ...
                          <br />
                          Rm 602, 6/F, Kowloon Building, 555 Nathan Road, Mong Kok
                        </span>
                      </p>
                      <p className="flex items-start">
                        <svg className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <span>2364 6018 / 2300 1810 / WhatsApp 6137 3411</span>
                      </p>
                      <p className="flex items-start">
                        <svg className="mr-3 mt-1 h-5 w-5 flex-shrink-0 text-primary" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Card className="overflow-hidden border border-gray-200 shadow-sm">
                  <CardContent className="p-6">
                    <h3 className="mb-4 text-xl font-bold">營業時間 / Opening Hours</h3>
